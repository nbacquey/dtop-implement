...
**)
let print_before = Examples.print_before
let print_after = Examples.print_after

let (t1,t2) = make_twin_transducers_2 6 2 5

let l = make_nontrivial_identity_transducer 3 2

let t = Examples.dtop_unwise

let (===) = Examples.ExEquivalence.Operations.Context_Before.(===)
let fold_dag = Examples.ExEquivalence.Operations.Context_Before.fold_dag
let fold_dag2 = Examples.ExEquivalence.Operations.Context_Before.fold_dag2
